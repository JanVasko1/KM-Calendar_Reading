...
def Download_Sharepoint(Settings: dict, Frame: CTk|CTkFrame, Download_Date_Range_Source: StringVar) -> CTkFrame:
    ...
    # Field - Use
    Use_Sharepoint_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Use", Field_Type="Input_RadioButton", Var_Value="Sharepoint") 
    ...
    # Field - User Email
    SP_Email_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Email", Field_Type="Input_Normal")
    ...
    SP_Date_From_Option = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date From", Field_Type="Input_OptionMenu") 
    ...
    SP_Date_To_Option = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date To", Field_Type="Input_OptionMenu") 
    ...
    SM_Man_Date_To_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Manual Date To", Field_Type="Input_Normal", Validation="Date") 
    ...
    # Field - Password
    SP_Password_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Password", Field_Type="Password_Normal") 
...
def Download_Manual(Settings: dict, Frame: CTk|CTkFrame, Download_Date_Range_Source: StringVar) -> CTkFrame:
    # ------------------------- Main Functions -------------------------#
    # Frame - General
    ...
    # Field - Use
    Use_Manual_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Use", Field_Type="Input_RadioButton", Var_Value="Manual") 
    ...
    # Field - User ID
    Man_Date_From_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date From", Field_Type="Input_Normal", Validation="Date") 
    ...
    # Field - User Email
    Man_Date_To_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date To", Field_Type="Input_Normal", Validation="Date")
...
def Download_Exchange(Settings: dict, Frame: CTk|CTkFrame, Download_Data_Source: StringVar) -> CTkFrame:
    ...
    # Field - Use
    Use_Exchange_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Use", Field_Type="Input_RadioButton", Var_Value="Exchange") 
    ...
    # Field - User ID
    Ex_Email_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Email", Field_Type="Input_Normal")
    ...
    # Field - Password
    Ex_Password_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Password", Field_Type="Password_Normal") 
...
def Download_Outlook(Settings: dict, Frame: CTk|CTkFrame, Download_Data_Source: StringVar) -> CTkFrame:
    Outlook_Email = Settings["General"]["Downloader"]["Outlook"]["Calendar"]
    ...
    # Field - Use
    Use_Outlook_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Use", Field_Type="Input_RadioButton", Var_Value="Outlook_Client") 
    ...
    # Field - User ID
    Out_Email_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Email", Field_Type="Input_Normal")
...
def Per_Period_Selection(Settings: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    Today = datetime.now()
    ...
    # Field - Year From
    Past_Year_From_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="From Year", Field_Type="Input_OptionMenu") 
    ...
    # Field - Month From
    Past_Month_From_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="From Month", Field_Type="Input_OptionMenu") 
    ...
    # Field - Year To
    Past_Year_To_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="To Year", Field_Type="Input_OptionMenu") 
    ...
    # Field - Month To
    Past_Month_To_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="To Month", Field_Type="Input_OptionMenu") 
...
def Pre_Download_Sharepoint(Settings: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    SP_Auth_Email = Settings["General"]["Downloader"]["Sharepoint"]["Auth"]["Email"]
    SP_Person_ID = Settings["General"]["Downloader"]["Sharepoint"]["Person"]["Code"]
    ...
    # Field - User ID
    Past_SP_User_ID_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="User ID", Field_Type="Input_Normal") 
    ...
    # Field - User Email
    Past_SP_Email_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Email", Field_Type="Input_Normal")
    ...
    # Field - Password
    Past_SP_Password_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Password", Field_Type="Password_Normal") 
