...
def Download_Sharepoint(Settings: dict, Configuration:dict, Frame: CTk|CTkFrame, Download_Date_Range_Source: StringVar, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Sharepoint_Disabling_Man_Date_To(Selected_Value: str, Entry_Field: CTkEntry, Drop_Down_But: CTkButton, Variable: StringVar) -> None:
        ...
        if (Selected_Value == "Today") or (Selected_Value == "Last Report Day"):
            ...
            Elements.Get_MessageBox(Configuration=Configuration, title="Error", message="Download To Method not allowed.", icon="cancel", fade_in_duration=1, GUI_Level_ID=1)
...
def Download_Manual(Settings: dict, Configuration:dict, Frame: CTk|CTkFrame, Download_Date_Range_Source: StringVar, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ------------------------- Main Functions -------------------------#
    # Frame - General
...
def Download_Exchange(Settings: dict, Configuration:dict, Frame: CTk|CTkFrame, Download_Data_Source: StringVar, GUI_Level_ID: int|None = None) -> CTkFrame:
    User_Email = Settings["0"]["General"]["User"]["Email"]
...
def Pre_Download_Sharepoint(Settings: dict, Configuration:dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    User_Email = Settings["0"]["General"]["User"]["Email"]
    User_ID = Settings["0"]["General"]["User"]["Code"]
