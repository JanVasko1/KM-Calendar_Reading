...
def Check_Time_Continuation(Settings: dict, Configuration: dict, Format_Time: str, Start_Time: CTkEntry, End_Time: CTkEntry, Week_Day: str, Type: str) -> bool:
    ...
    if Start_Time_dt >= End_Time_dt:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", f"{Week_Day}", f"{Type}", "End_Time"], Information=End_Time.get())
...
def Calculate_duration(Settings: dict, Configuration: dict, Entry_Field: CTkEntry, Lunch_Brake_Duration_Frame_Var: int, Calendar_Type: str, Monday_Start: CTkEntry, Monday_End: CTkEntry, Tuesday_Start: CTkEntry, Tuesday_End: CTkEntry, Wednesday_Start: CTkEntry, Wednesday_End: CTkEntry, Thursday_Start: CTkEntry, Thursday_End: CTkEntry, Friday_Start: CTkEntry, Friday_End: CTkEntry, Saturday_Start: CTkEntry, Saturday_End: CTkEntry, Sunday_Start: CTkEntry, Sunday_End: CTkEntry) -> None:
    ...
    def Calculate_day_duration(Start_Time: str, End_Time: str, Week_Day: str, Calendar_Type: str, Working_Day: bool) -> int:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", f"{Week_Day}", f"{Calendar_Type}", "Day_Duration"], Information=Duration)
        return Duration
    ...
    if Calendar_Type == "Work_Hours":
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Totals", "Work"], Information=Total_Duration)
    elif Calendar_Type == "Vacation":
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Totals", "Vacation"], Information=Total_Duration)
    else:
...
# -------------------------------------------------------------------------------------------------------------------------------------------------- Main Functions -------------------------------------------------------------------------------------------------------------------------------------------------- #
# -------------------------------------------------------------------------- Tab Appearance --------------------------------------------------------------------------#
def Settings_General_Appearance(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    Accent_Color_Manual_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Accent Color Manual", Field_Type="Color_Picker") 
    ...
    Hover_Color_Manual_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Hover Color Manual", Field_Type="Color_Picker") 
...
def Settings_User_Widget(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Password_required(User_Type_Variable: StringVar, User_Type_Frame_Var: str) -> None:
        ...
        if User_Type_Frame_Var == "User":
            ...
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=User_Type_Variable, File_Name="Settings", JSON_path=["0", "General", "User", "User_Type"], Information=User_Type_Frame_Var)
    ...
    User_ID_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Code"], Information=User_ID_Frame_Var.get()))
    ...
    User_Name_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Name"], Information=User_Name_Frame_Var.get()))
    ...
    User_Email_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Email"], Information=User_Email_Frame_Var.get()))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Default_Page_Frame_Var, values=Page_Selected_list, command=lambda Default_Page_Frame_Var: Data_Functions.Save_Value(Settings=None, Configuration=Configuration, Variable=Page_Selected_Variable, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Init_Page", "Selected"], Information=Default_Page_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_General_Sharepoint(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=SP_Team_Frame_Var, values=SP_Teams_List, command=lambda SP_Team_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=SP_Team_Variable, File_Name="Settings", JSON_path=["0", "General", "Downloader", "Sharepoint", "Teams", "My_Team"], Information=SP_Team_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_General_Exchange(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    # Section Quantities
    Elements_Groups.Get_Widget_Section_row(Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Categories", Label_Size="Field_Label" , Font_Size="Section_Separator")
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Category_Color_Frame_Var, values=Category_Color_list, command=lambda Category_Color_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Category_Non_Active_Color_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Project", "Colors", "Non_Active_Color"], Information=Category_Color_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Section Quantities
    Elements_Groups.Get_Widget_Section_row(Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="OAuth2", Label_Size="Field_Label" , Font_Size="Section_Separator")
...
def Settings_General_Formats(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    # Field - Sharepoint DateTime Format
    ...
    Sharepoint_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Date 1", Field_Type="Input_Normal")
    ...
    # Field - Sharepoint Date Format 1
    Sharepoint_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Date 2", Field_Type="Input_Normal")
    Sharepoint_Date_Frame_Var = Sharepoint_Date_Frame.children["!ctkframe3"].children["!ctkentry"]
    Sharepoint_Date_Frame_Var.configure(placeholder_text=Format_Sharepoint_Date1, placeholder_text_color="#949A9F")
    Sharepoint_Date_Frame_Var.configure(state="disabled")

    # Field - Sharepoint Date Format 2
    ...
    # Field - Sharepoint Time Format
    Sharepoint_Time_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Time 2", Field_Type="Input_Normal")
    Sharepoint_Time_Frame_Var = Sharepoint_Time_Frame.children["!ctkframe3"].children["!ctkentry"]
    Sharepoint_Time_Frame_Var.configure(placeholder_text=Format_Sharepoint_Time1, placeholder_text_color="#949A9F")
    Sharepoint_Time_Frame_Var.configure(state="disabled")
...
def Settings_Parallel_events(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Parallel_Events_Var.configure(variable=Parallel_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Parallel_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Parallel_Events", "Use"], Information=Parallel_Use_Variable))
...
def Settings_Join_events(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Events_Joining_Var.configure(variable=Join_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Join_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Join_method", "Use"], Information=Join_Use_Variable))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Join_Free_Frame_Var, values=Join_Methods_List, command=lambda Join_Free_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Join_Free_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Join_method", "Free"], Information=Join_Free_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Join_Busy_Frame_Var, values=Join_Methods_List, command=lambda Join_Busy_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Join_Busy_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Join_method", "Busy"], Information=Join_Busy_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Join_OutOfOffice_Frame_Var, values=Join_Methods_List, command=lambda Join_OutOfOffice_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Join_OutOfOffice_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Join_method", "Out of Office"], Information=Join_OutOfOffice_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_Calendar_Working_Hours(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Monday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Monday", "Work_Hours", "Start_Time"], Information=Monday_Frame_Var1.get()))
    ...
    Tuesday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Tuesday", "Work_Hours", "Start_Time"], Information=Tuesday_Frame_Var1.get()))
    ...
    Wednesday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Wednesday", "Work_Hours", "Start_Time"], Information=Wednesday_Frame_Var1.get()))
    ...
    Thursday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Thursday", "Work_Hours", "Start_Time"], Information=Thursday_Frame_Var1.get()))
    ...
    Friday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Friday", "Work_Hours", "Start_Time"], Information=Friday_Frame_Var1.get()))
    ...
    Saturday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Saturday", "Work_Hours", "Start_Time"], Information=Saturday_Frame_Var1.get()))
    ...
    Sunday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Sunday", "Work_Hours", "Start_Time"], Information=Sunday_Frame_Var1.get()))
    ...
    Lunch_Brake_Duration_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Lunch_Brake_Dur"], Information=int(Lunch_Brake_Duration_Frame_Var.get())))
...
def Settings_Calendar_Vacation(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Monday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Monday", "Vacation", "Start_Time"], Information=Monday_Vac_Frame_Var1.get()))
    ...
    Tuesday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Tuesday", "Vacation", "Start_Time"], Information=Tuesday_Vac_Frame_Var1.get()))
    ...
    Wednesday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Wednesday", "Vacation", "Start_Time"], Information=Wednesday_Vac_Frame_Var1.get()))
    ...
    Thursday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Thursday", "Vacation", "Start_Time"], Information=Thursday_Vac_Frame_Var1.get()))
    ...
    Friday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Friday", "Vacation", "Start_Time"], Information=Friday_Vac_Frame_Var1.get()))
    ...
    Saturday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Saturday", "Vacation", "Start_Time"], Information=Saturday_Vac_Frame_Var1.get()))
    ...
    Sunday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Sunday", "Vacation", "Start_Time"], Information=Sunday_Vac_Frame_Var1.get()))
...
def Settings_Calendar_Start_End_Time(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Check_Same_Values(Start_Event_Var: CTkEntry, End_Event_Var: CTkEntry) -> bool:
        if Start_Event_Var.get() == End_Event_Var.get():
            ...
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Start_End_Events", "End"], Information=End_Event_Var.get())
    ...
    Start_Event_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Start_End_Events", "Start"], Information=Start_Event_Var.get()))
...
def Settings_Events_General_Lunch(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Lunch_Var.configure(variable=Lunch_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Lunch_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Lunch", "Use"], Information=Lunch_Use_Variable))
    ...
    Search_Text_Lunch_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Lunch", "Search_Text"], Information=Search_Text_Lunch_Var.get()))
...
def Settings_Events_General_Vacation(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Vacation_Var.configure(variable=Vacation_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Vacation_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Vacation", "Use"], Information=Vacation_Use_Variable))
    ...
    Search_Text_Vacation_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Vacation", "Search_Text"], Information=Search_Text_Vacation_Var.get()))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=All_Day_Vacation_Var, values=Vacation_Day_Option_List, command=lambda All_Day_Vacation_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Vacation_All_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Vacation", "All_Day"], Information=All_Day_Vacation_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    Delete_Events_Vacation_Var.configure(variable=Vacation_Delete_Events_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Vacation_Delete_Events_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Vacation", "Delete_Events_w_Working_Hours"], Information=Vacation_Delete_Events_Variable))
...
def Settings_Events_General_SickDay(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_SickDay_Var.configure(variable=SickDay_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=SickDay_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "SickDay", "Use"], Information=SickDay_Use_Variable))
    ...
    Search_Text_SickDay_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "SickDay", "Search_Text"], Information=Search_Text_SickDay_Var.get()))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Part_Day_SickDay_Var, values=SickDay_Day_Option_List, command=lambda Part_Day_SickDay_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=SickDay_Part_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "SickDay", "Part_Day"], Information=Part_Day_SickDay_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    Delete_Events_SickDay_Var.configure(variable=SickDay_Delete_Events_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=SickDay_Delete_Events_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "SickDay", "Delete_Events_w_Working_Hours"], Information=SickDay_Delete_Events_Variable))
...
def Settings_Events_General_HomeOffice(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_HomeOffice_Var.configure(variable=HomeOffice_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=HomeOffice_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "HomeOffice", "Use"], Information=HomeOffice_Use_Variable))
    ...
    Search_Text_HomeOffice_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "HomeOffice", "Search_Text"], Information=Search_Text_HomeOffice_Var.get()))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Part_Day_HomeOffice_Var, values=HomeOffice_Day_Option_List, command=lambda Part_Day_HomeOffice_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=HomeOffice_Part_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "HomeOffice", "Part_Day"], Information=Part_Day_HomeOffice_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_Events_General_Private(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Private_Var.configure(variable=Private_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Private_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Private", "Use"], Information=Private_Use_Variable))
    ...
    Search_Text_Private_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Private", "Search_Text"], Information=Search_Text_Private_Var.get()))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Method_Private_Var, values=Private_Method_List, command=lambda Method_Private_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Private_Method_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Special_Events", "Private", "Method"], Information=Method_Private_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_Events_General_Skip(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_Skip_Event(Header_List: list, Subject_Text_Text_Var: CTkEntry, Frame_Skip_Table_Var: CTkTable) -> None:
        ...
        if Add_flag == True:
            ...
            Skip_Events.sort()
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Skip", "Skip_List"], Information=Skip_Events)
        else:
    ...
    def Del_Skip_Event_all(Frame_Skip_Table_Var: CTkTable) -> None:
        ...
        for Table_index in range(1, Table_len):
            Frame_Skip_Table_Var.delete_row(index=Table_index)
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Skip", "Skip_List"], Information=[])
    ...
    def Load_Skip(Button_Load_Skip: CTkButton):
        def Skip_drop_func(file):
            ...
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Skip_Events", JSON_path=["0", "Event_Handler", "Events", "Skip", "Skip_List"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_Skip_Table_Var, JSON_path=["0", "Event_Handler", "Events", "Skip", "Skip_List"])
    ...
    Use_Skip_Event_Var.configure(variable=Skip_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Skip_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Skip", "Use"], Information=Skip_Use_Variable))
...
def Settings_Events_Empty_Generally(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_Empty_Event(Header_List: list, Frame_Empty_General_Table_Var: CTkTable, Subject_Text_Text_Var: CTkEntry, Project_Option_Var1: CTkOptionMenu, Activity_Option_Var1: CTkOptionMenu, Coverage_Text_Var: CTkEntry) -> None:
        ...
        if Add_flag == True:
            ...
            for Empty_General_Events_row in Empty_General_Events:
                ...
                Counter += 1
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "General"], Information=General_dict)
        else:
            pass
    ...
    def Del_Empty_Event_All(Frame_Empty_General_Table_Var: CTkTable) -> None:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "General"], Information={})
    ...
    def Load_Empty(Button_Load_Empty: CTkButton):
        def Empty_drop_func(file):
            response = Elements.Get_MessageBox(Configuration=Configuration, title="Question", message=f"Do you want to overwrite data or add them?", icon="question", fade_in_duration=1, option_1="Overwrite", option_2="Add", GUI_Level_ID=1)
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Empty_Events", JSON_path=["0", "Event_Handler", "Events", "Empty", "General"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_Empty_General_Table_Var, JSON_path=["0", "Event_Handler", "Events", "Empty", "General"])
            Import_window.destroy()
            Elements.Get_MessageBox(Configuration=Configuration, title="Success", message=f"Your settings file has been imported. You can close Window.", icon="check", fade_in_duration=1, GUI_Level_ID=1)
...
def Settings_Events_Empty_Schedule(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_Schedule_Event(Header_List: list, Frame_Empty_Schedules_Table_Var: CTkTable, Subject_Text_Text_Var: CTkEntry, Project_Option_Var2: CTkOptionMenu, Activity_Option_Var2: CTkOptionMenu, Start_Time_Text_Var: CTkEntry, End_Time_Text_Var: CTkEntry, Monday_Check_Frame_Var: CTkCheckBox, Tuesday_Check_Frame_Var: CTkCheckBox, Wednesday_Check_Frame_Var: CTkCheckBox, Thursday_Check_Frame_Var: CTkCheckBox, Friday_Check_Frame_Var: CTkCheckBox, Saturday_Check_Frame_Var: CTkCheckBox, Sunday_Check_Frame_Var: CTkCheckBox) -> None:
        ...
        if Add_flag == True:
            ...
            for Schedule_Events_row in Schedule_Events:
                ...
                Counter += 1
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "Scheduled"], Information=Scheduled_dict)
        else:
            pass
    ...
    def Del_Schedule_Event_All(Frame_Empty_Schedules_Table_Var: CTkTable) -> None:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "Scheduled"], Information={})
    ...
    def Load_Scheduler(Button_Load_Scheduler: CTkButton):
        def Scheduler_drop_func(file):
            response = Elements.Get_MessageBox(Configuration=Configuration, title="Question", message=f"Do you want to overwrite data or add them?", icon="question", fade_in_duration=1, option_1="Overwrite", option_2="Add", GUI_Level_ID=1)
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Scheduler", JSON_path=["0", "Event_Handler", "Events", "Empty", "Scheduled"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_Empty_Schedules_Table_Var, JSON_path=["0", "Event_Handler", "Events", "Empty", "Scheduled"])
            Import_window.destroy()
            Elements.Get_MessageBox(Configuration=Configuration, title="Success", message=f"Your settings file has been imported. You can close Window.", icon="check", fade_in_duration=1, GUI_Level_ID=1)
...
def Settings_Events_Split(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Use_Empty_Split_Var.configure(variable=Empty_Split_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Empty_Split_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "Split", "Use"], Information=Empty_Split_Use_Variable))
    ...
    Split_Duration_Text_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "Split", "Split_Duration"], Information=int(Split_Duration_Text_Var.get())))
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Split_Method_Var, values=Events_Empty_Split_list, command=lambda Split_Method_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Events_Empty_Split_list_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Empty", "Split", "Split_Method"], Information=Split_Method_Var), GUI_Level_ID=GUI_Level_ID)
...
def Settings_Events_AutoFill(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_AutoFill_Event(Header_List: list, Frame_AutoFiller_Table_Var: CTkTable, Subject_Text_Text_Var: CTkEntry, Project_Option_Var: CTkOptionMenu, Activity_Option_Var: CTkOptionMenu, Location_Option_Var: CTkOptionMenu) -> None:
        ...
        if Add_flag == True:
            ...
            for Auto_Fill_Events_row in Auto_Fill_Events:
                ...
                Counter += 1
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Search_Text", "Dictionary"], Information=AutoFill_dict)
        else:
            pass
    ...
    def Del_AutoFill_Event_All(Frame_AutoFiller_Table_Var: CTkTable) -> None:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Search_Text", "Dictionary"], Information={})
    ...
    def Load_AutoFill(Button_Load_AutoFill: CTkButton):
        def AutoFill_drop_func(file):
            response = Elements.Get_MessageBox(Configuration=Configuration, title="Question", message=f"Do you want to overwrite data or add them?", icon="question", fade_in_duration=1, option_1="Overwrite", option_2="Add", GUI_Level_ID=1)
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Rules", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Search_Text", "Dictionary"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_AutoFiller_Table_Var, JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Search_Text", "Dictionary"])
            Import_window.destroy()
            Elements.Get_MessageBox(Configuration=Configuration, title="Success", message=f"Your settings file has been imported. You can close Window.", icon="check", fade_in_duration=1, GUI_Level_ID=1)
    ...
    Use_AutoFill_Var.configure(variable=AutoFill_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=AutoFill_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Search_Text", "Use"], Information=AutoFill_Use_Variable))
...
def Settings_Events_Activity_Correction(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_Activity_Correct_Event(Header_List: list, Frame_Activity_Correct_Table_Var: CTkTable, Project_Option_Var: CTkOptionMenu, Wrong_Activity_Option_Var: CTkOptionMenu, Correct_Activity_Option_Var: CTkOptionMenu) -> None:
        ...
        if Add_flag == True:
            ...
            for Activity_Corrections_Events_row in Activity_Corrections_Events:
                ...
                Counter += 1
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Activity_Correction", "Dictionary"], Information=Activity_Correction_dict)
        else:
            pass
    ...
    def Del_Activity_Correct_Event_all(Frame_Activity_Correct_Table_Var: CTkTable) -> None:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Activity_Correction", "Dictionary"], Information={})
    ...
    def Load_Activity_Correct(Button_Load_Activity_Correct: CTkButton):
        def Activity_Correct_drop_func(file):
            response = Elements.Get_MessageBox(Configuration=Configuration, title="Question", message=f"Do you want to overwrite data or add them?", icon="question", fade_in_duration=1, option_1="Overwrite", option_2="Add", GUI_Level_ID=1)
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Activity_Correction", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Activity_Correction", "Dictionary"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_Activity_Correct_Table_Var, JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Activity_Correction", "Dictionary"])
            Import_window.destroy()
            Elements.Get_MessageBox(Configuration=Configuration, title="Success", message=f"Your settings file has been imported. You can close Window.", icon="check", fade_in_duration=1, GUI_Level_ID=1)
    ...
    Use_Activity_Correction_Var.configure(variable=Activity_Correction_Use_Variable, text="", command=lambda : Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=Activity_Correction_Use_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Auto_Filler", "Activity_Correction", "Use"], Information=Activity_Correction_Use_Variable))
...
def Settings_My_Team(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    def Add_Team_User(Header_List: list, Frame_Managed_Team_Table_Var: CTkTable, MT_SP_Teams_Frame_Var: CTkOptionMenu, MT_User_ID_Frame_Var: CTkEntry, MT_User_Name_Frame_Var: CTkEntry) -> None:
        ...
        if Add_flag == True:
            ...
            for Managed_Team_Users_row in Managed_Team_Users:
                ...
                Counter += 1
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Managed_Team"], Information=Managed_Users_dict)
    ...
    def Del_Team_User_One(Button_MT_Del_One_Var: CTkButton):
        def Delete_Managed_Member_Confirm(Frame_Managed_Team_Table_Var: CTkTable, LineNo_Option_Var: CTkOptionMenu, User_ID_Label_Var: CTkLabel) -> None:
            ...
            File_Manipulation.Delete_All_Files(file_path=Folder_Path, include_hidden=True)
            File_Manipulation.Delete_Folder(file_path=Folder_Path)
    ...
    def Del_Team_User_all(Frame_Managed_Team_Table_Var: CTkTable) -> None:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Managed_Team"], Information={})
        File_Manipulation.Delete_Folders(file_path=Data_Functions.Absolute_path(relative_path=f"Operational\\My_Team"))
    ...
    def Load_MT(Button_Load_MT: CTkButton):
        def MT_drop_func(file: str) -> None:
            response = Elements.Get_MessageBox(Configuration=Configuration, title="Question", message=f"Do you want to overwrite data or add them?", icon="question", fade_in_duration=1, option_1="Overwrite", option_2="Add", GUI_Level_ID=1)
            Data_Functions.Import_Data(Settings=Settings, Configuration=Configuration, import_file_path=file, Import_Type="TimeSheets_Team", JSON_path=["0", "General", "User", "Managed_Team"], Method=response)
            CustomTkinter_Functions.Insert_Data_to_Table(Settings=Settings, Configuration=Configuration, Table=Frame_Managed_Team_Table_Var, JSON_path=["0", "General", "User", "Managed_Team"])
            Import_window.destroy()  
            Elements.Get_MessageBox(Configuration=Configuration, title="Success", message=f"Your settings file has been imported. You can close Window.", icon="check", fade_in_duration=1, GUI_Level_ID=1)
