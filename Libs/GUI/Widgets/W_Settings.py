...
def Check_Time_Continuation(Settings: dict, Configuration: dict, window: CTk|None, Format_Time: str, Start_Time: CTkEntry, End_Time: CTkEntry, Week_Day: str, Type: str) -> bool:
    ...
    if Start_Time_dt >= End_Time_dt:
        ...
        Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", f"{Week_Day}", f"{Type}", "End_Time"], Information=End_Time.get())
...
def Calculate_duration(Settings: dict, Configuration: dict, window: CTk|None, Entry_Field: CTkEntry, Lunch_Brake_Duration_Frame_Var: int, Calendar_Type: str, Monday_Start: CTkEntry, Monday_End: CTkEntry, Tuesday_Start: CTkEntry, Tuesday_End: CTkEntry, Wednesday_Start: CTkEntry, Wednesday_End: CTkEntry, Thursday_Start: CTkEntry, Thursday_End: CTkEntry, Friday_Start: CTkEntry, Friday_End: CTkEntry, Saturday_Start: CTkEntry, Saturday_End: CTkEntry, Sunday_Start: CTkEntry, Sunday_End: CTkEntry) -> None:
...
# -------------------------------------------------------------------------------------------------------------------------------------------------- Main Functions -------------------------------------------------------------------------------------------------------------------------------------------------- #
# -------------------------------------------------------------------------- Tab Appearance --------------------------------------------------------------------------#
def Settings_General_Appearance(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    def Settings_Disabling_Color_Pickers(Selected_Value: str, Entry_Field: CTkEntry, Picker_Button: CTkButton, Variable: StringVar, Helper: str) -> None:
        if Selected_Value == "Windows":
            ...
            # Accent only
            Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=Variable, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Colors", "Accent", "Accent_Color_Mode"], Information=Selected_Value)
            ...
            if Helper == "Accent":
                ...
                Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=Variable, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Colors", "Hover", "Hover_Color_Mode"], Information=Selected_Value)
    ...
    def Appearance_Pick_Manual_Color(Clicked_on: CTkButton, Color_Manual_Frame_Var: CTkEntry, Helper: str, GUI_Level_ID: int|None = None) -> None:
        def Quit_Save(Helper: str):
            Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=None, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Colors", f"{Helper}", f"{Helper}_Color_Manual"], Information=Color_Picker_Frame.get())
    ...
    def Appearance_Change_Theme(Theme_Frame_Var: CTkOptionMenu) ->  None:
        ...
        Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=Theme_Variable, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Theme"], Information=Theme_Frame_Var)
    ...
    Accent_Color_Manual_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=None, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Colors", "Accent", "Accent_Color_Manual"], Information=Accent_Color_Manual_Frame_Var.get()))
    ...
    Hover_Color_Manual_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=None, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Colors", "Hover", "Hover_Color_Manual"], Information=Hover_Color_Manual_Frame_Var.get()))
...
def Settings_User_Widget(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    def Password_required(User_Type_Variable: StringVar, User_Type_Frame_Var: str) -> None:
        ...
        if User_Type_Frame_Var == "User":
            ...
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=User_Type_Variable, File_Name="Settings", JSON_path=["0", "General", "User", "User_Type"], Information=User_Type_Frame_Var)
    ...
    # Field - User ID
    User_ID_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="User ID", Field_Type="Input_Normal")
    ...
    User_ID_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Code"], Information=User_ID_Frame_Var.get()))
    Entry_field_Insert(Field=User_ID_Frame_Var, Value=User_ID)

    # Field - Name
    User_Name_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="User Name", Field_Type="Input_Normal") 
    ...
    User_Name_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Name"], Information=User_Name_Frame_Var.get()))
    Entry_field_Insert(Field=User_Name_Frame_Var, Value=User_Name)

    # Field - User Email
    User_Email_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="User Email", Field_Type="Input_Normal")
    ...
    User_Email_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "User", "Email"], Information=User_Email_Frame_Var.get()))
    Entry_field_Insert(Field=User_Email_Frame_Var, Value=User_Email)

    # Field - Default Page after start
    Default_Page_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Default page", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Default_Page_Frame_Var, values=Page_Selected_list, command=lambda Default_Page_Frame_Var: Data_Functions.Save_Value(Settings=None, Configuration=Configuration, window=window, Variable=Page_Selected_Variable, File_Name="Configuration", JSON_path=["Global_Appearance", "Window", "Init_Page", "Selected"], Information=Default_Page_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - User Type
    User_Type_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="User Type", Field_Type="Input_OptionMenu") 
...
# -------------------------------------------------------------------------- Tab GEneral --------------------------------------------------------------------------#
def Settings_General_Sharepoint(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    # Field - Team
    SP_Team_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Team", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=SP_Team_Frame_Var, values=SP_Teams_List, command=lambda SP_Team_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=SP_Team_Variable, File_Name="Settings", JSON_path=["0", "General", "Downloader", "Sharepoint", "Teams", "My_Team"], Information=SP_Team_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - File Name 
    SP_File_Name_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="File Name", Field_Type="Input_Normal")
    ...
    # Field - Auth Address
    SP_Auth_Address_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Auth Address", Field_Type="Input_Normal")
...
def Settings_General_Exchange(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    Category_Color_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Category Active Color", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Category_Color_Frame_Var, values=Category_Color_list, command=lambda Category_Color_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=Category_Active_Color_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Project", "Colors", "Active_Color"], Information=Category_Color_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - Non Active Category Color
    Category_Color_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Category Non-Active Color", Field_Type="Input_OptionMenu") 
    Category_Color_Frame_Var = Category_Color_Frame.children["!ctkframe3"].children["!ctkoptionmenu"]
    Category_Color_Frame_Var.configure(variable=Category_Non_Active_Color_Variable)
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=Category_Color_Frame_Var, values=Category_Color_list, command=lambda Category_Color_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=Category_Non_Active_Color_Variable, File_Name="Settings", JSON_path=["0", "Event_Handler", "Project", "Colors", "Non_Active_Color"], Information=Category_Color_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    # Field - Tenant ID
    EX_Tenant_ID_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Tenant ID", Field_Type="Input_Normal")
...
def Settings_General_Formats(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    Program_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date", Field_Type="Input_Normal") 
    ...
    Program_Time_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Time", Field_Type="Input_Normal")
    ...
    Exchange_DateTime_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Exchange DateTime", Field_Type="Input_Normal")
    ...
    Sharepoint_DateTime_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint DateTime", Field_Type="Input_Normal")
    ...
    Sharepoint_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Date 1", Field_Type="Input_Normal")
    ...
    Sharepoint_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Date 2", Field_Type="Input_Normal")
    Sharepoint_Date_Frame_Var = Sharepoint_Date_Frame.children["!ctkframe3"].children["!ctkentry"]
    ...
    Sharepoint_Date_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Date 3", Field_Type="Input_Normal")
    Sharepoint_Date_Frame_Var = Sharepoint_Date_Frame.children["!ctkframe3"].children["!ctkentry"]
    ...
    Sharepoint_Time_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Time 1", Field_Type="Input_Normal")
    ...
    # Field - Sharepoint Time Format
    Sharepoint_Time_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Sharepoint Time 2", Field_Type="Input_Normal")
    Sharepoint_Time_Frame_Var = Sharepoint_Time_Frame.children["!ctkframe3"].children["!ctkentry"]
...
# -------------------------------------------------------------------------- Tab Calendar --------------------------------------------------------------------------#
def Settings_Calendar_Working_Hours(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    Format_Time = Settings["0"]["General"]["Formats"]["Time"]
    ...
    Monday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Monday", "Work_Hours", "Start_Time"], Information=Monday_Frame_Var1.get()))
    ...
    Monday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Monday_Frame_Var1, End_Time=Monday_Frame_Var2, Week_Day="Monday", Type="Work_Hours"))
    ...
    Tuesday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Tuesday", "Work_Hours", "Start_Time"], Information=Tuesday_Frame_Var1.get()))
    ...
    Tuesday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Tuesday_Frame_Var1, End_Time=Tuesday_Frame_Var2, Week_Day="Tuesday", Type="Work_Hours"))
    ...
    Wednesday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Wednesday", "Work_Hours", "Start_Time"], Information=Wednesday_Frame_Var1.get()))
    ...
    Wednesday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Wednesday_Frame_Var1, End_Time=Wednesday_Frame_Var2, Week_Day="Wednesday", Type="Work_Hours"))
    ...
    Thursday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Thursday", "Work_Hours", "Start_Time"], Information=Thursday_Frame_Var1.get()))
    ...
    Thursday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Thursday_Frame_Var1, End_Time=Thursday_Frame_Var2, Week_Day="Thursday", Type="Work_Hours"))
    ...
    Friday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Friday", "Work_Hours", "Start_Time"], Information=Friday_Frame_Var1.get()))
    ...
    Friday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Friday_Frame_Var1, End_Time=Friday_Frame_Var2, Week_Day="Friday", Type="Work_Hours"))
    ...
    Saturday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Saturday", "Work_Hours", "Start_Time"], Information=Saturday_Frame_Var1.get()))
    ...
    Saturday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Saturday_Frame_Var1, End_Time=Saturday_Frame_Var2, Week_Day="Saturday", Type="Work_Hours"))
    ...
    Sunday_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Sunday", "Work_Hours", "Start_Time"], Information=Sunday_Frame_Var1.get()))
    ...
    Sunday_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Sunday_Frame_Var1, End_Time=Sunday_Frame_Var2, Week_Day="Sunday", Type="Work_Hours"))
    Entry_field_Insert(Field=Sunday_Frame_Var2, Value=Sunday_Work_End)

    # Field - Lunch Break duration
    Lunch_Brake_Duration_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Lunch brake duration", Field_Type="Input_Normal", Validation="Integer")
    Lunch_Brake_Duration_Frame_Var = Lunch_Brake_Duration_Frame.children["!ctkframe3"].children["!ctkentry"]
    Lunch_Brake_Duration_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Lunch_Brake_Dur"], Information=int(Lunch_Brake_Duration_Frame_Var.get())))
    Entry_field_Insert(Field=Lunch_Brake_Duration_Frame_Var, Value=Lunch_Brake_Duration)

    # Field - Total Time
    Work_Calendar_Total = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Total Time", Field_Type="Input_Normal")
    ...
    Button_Skip_Add_Var.configure(text="Calculate", command = lambda: Calculate_duration(Settings=Settings, Configuration=Configuration, window=window, Entry_Field=Work_Calendar_Total_Var, Lunch_Brake_Duration_Frame_Var=int(Lunch_Brake_Duration_Frame_Var.get()), Calendar_Type="Work_Hours", Monday_Start=Monday_Frame_Var1, Monday_End=Monday_Frame_Var2, Tuesday_Start=Tuesday_Frame_Var1, Tuesday_End=Tuesday_Frame_Var2, Wednesday_Start=Wednesday_Frame_Var1, Wednesday_End=Wednesday_Frame_Var2, Thursday_Start=Thursday_Frame_Var1, Thursday_End=Thursday_Frame_Var2, Friday_Start=Friday_Frame_Var1, Friday_End=Friday_Frame_Var2, Saturday_Start=Saturday_Frame_Var1, Saturday_End=Saturday_Frame_Var2, Sunday_Start=Sunday_Frame_Var1, Sunday_End=Sunday_Frame_Var2))
...
def Settings_Calendar_Vacation(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    Format_Time = Settings["0"]["General"]["Formats"]["Time"]
    ...
    Monday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Monday", "Vacation", "Start_Time"], Information=Monday_Vac_Frame_Var1.get()))
    ...
    Monday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Monday_Vac_Frame_Var1, End_Time=Monday_Vac_Frame_Var2, Week_Day="Monday", Type="Vacation"))
    ...
    Tuesday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Tuesday", "Vacation", "Start_Time"], Information=Tuesday_Vac_Frame_Var1.get()))
    ...
    Tuesday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Tuesday_Vac_Frame_Var1, End_Time=Tuesday_Vac_Frame_Var2, Week_Day="Tuesday", Type="Vacation"))
    ...
    Wednesday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Wednesday", "Vacation", "Start_Time"], Information=Wednesday_Vac_Frame_Var1.get()))
    ...
    Wednesday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Wednesday_Vac_Frame_Var1, End_Time=Wednesday_Vac_Frame_Var2, Week_Day="Wednesday", Type="Vacation"))
    ...
    Thursday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Thursday", "Vacation", "Start_Time"], Information=Thursday_Vac_Frame_Var1.get()))
    ...
    Thursday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Thursday_Vac_Frame_Var1, End_Time=Thursday_Vac_Frame_Var2, Week_Day="Thursday", Type="Vacation"))
    ...
    Friday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Friday", "Vacation", "Start_Time"], Information=Friday_Vac_Frame_Var1.get()))
    ...
    Friday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Friday_Vac_Frame_Var1, End_Time=Friday_Vac_Frame_Var2, Week_Day="Friday", Type="Vacation"))
    ...
    Saturday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Saturday", "Vacation", "Start_Time"], Information=Saturday_Vac_Frame_Var1.get()))
    ...
    Saturday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Saturday_Vac_Frame_Var1, End_Time=Saturday_Vac_Frame_Var2, Week_Day="Saturday", Type="Vacation"))
    ...
    Sunday_Vac_Frame_Var1.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Calendar", "Sunday", "Vacation", "Start_Time"], Information=Sunday_Vac_Frame_Var1.get()))
    ...
    Sunday_Vac_Frame_Var2.bind("<FocusOut>", lambda Entry_value: Check_Time_Continuation(Settings=Settings, Configuration=Configuration, window=window, Format_Time=Format_Time, Start_Time=Sunday_Vac_Frame_Var1, End_Time=Sunday_Vac_Frame_Var2, Week_Day="Sunday", Type="Vacation"))
    Entry_field_Insert(Field=Sunday_Vac_Frame_Var2, Value=Sunday_Vacation_End)

    # Field - Total Time
    Vacation_Calendar_Total = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Total Time", Field_Type="Input_Normal")
...
def Settings_Calendar_Start_End_Time(Settings: dict, Configuration: dict, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    def Check_Same_Values(Start_Event_Var: CTkEntry, End_Event_Var: CTkEntry) -> bool:
        if Start_Event_Var.get() == End_Event_Var.get():
            ...
            Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Start_End_Events", "End"], Information=End_Event_Var.get())
    ...
    # Field - Work - Start
    Start_Event = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Work - Start", Field_Type="Input_Normal") 
    ...
    Start_Event_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "Event_Handler", "Events", "Start_End_Events", "Start"], Information=Start_Event_Var.get()))
    Entry_field_Insert(Field=Start_Event_Var, Value=Start_Event_json)

    # Field - Work - End
    End_Event = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Work - End", Field_Type="Input_Normal") 
