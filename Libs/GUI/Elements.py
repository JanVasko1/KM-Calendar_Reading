...
def Get_Button_Chart(Frame: CTk|CTkFrame, Button_Size: str) -> CTkButton:
    ...
    Accent_Color_help = Define_Accent_Color(Color_json=Configuration_Button_Chart["Accent_Color_help"])
    hover_color = Define_Hover_Color(Color_json=Configuration_Button_Chart["hover_color"], Accent_Color=Accent_Color_help)
    ...
    Frame_Button = CTkButton(
        ...
        fg_color = Configuration_Button_Chart["fg_color"],
