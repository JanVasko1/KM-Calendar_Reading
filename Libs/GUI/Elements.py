...
def Get_Button_Chart(Configuration:dict, Frame: CTkFrame, Button_Size: str) -> CTkButton:
...
def Get_Dashboards_Frame(Configuration:dict, Frame: CTkFrame, Frame_Size: str, GUI_Level_ID: int|None = None) -> CTkFrame:
...
def Get_Dashboard_Widget_Frame_Body(Configuration:dict, Frame: CTkFrame, Widget_Line: str, Widget_size: str, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    if type(GUI_Level_ID) is int:
        ...
        border_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID}"]["border_color"])
        if GUI_Level_ID == 0:
            bg_color = tuple(Configuration_Frame_Dash_Body["bg_color"])
        else:
            bg_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID - 1}"]["fg_color"])
    else:
        border_color = tuple(Configuration_Frame_Dash_Body["border_color"])
        if Configuration_Frame_Dash_Body["fg_color"] == "transparent":
            fg_color = Configuration_Frame_Dash_Body["fg_color"]
        else:
            fg_color = tuple(Configuration_Frame_Dash_Body["fg_color"])
        if Configuration_Frame_Dash_Body["bg_color"] == "transparent":
...
def Get_Dashboard_Widget_Frame_Body_Scrollable(Configuration:dict, Frame: CTkFrame, Widget_Line: str, Widget_size: str, GUI_Level_ID: int|None = None) -> CTkScrollableFrame:
    ...
    if type(GUI_Level_ID) is int:
        ...
        border_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID}"]["border_color"])
        if GUI_Level_ID == 0:
            bg_color = tuple(Configuration_Frame_Dash_Body_Scroll["bg_color"])
        else:
            bg_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID - 1}"]["fg_color"])
    else:
        border_color = tuple(Configuration_Frame_Dash_Body_Scroll["border_color"])
        if Configuration_Frame_Dash_Body_Scroll["fg_color"] == "transparent":
            fg_color = Configuration_Frame_Dash_Body_Scroll["fg_color"]
        else:
            fg_color = tuple(Configuration_Frame_Dash_Body_Scroll["fg_color"])
        if Configuration_Frame_Dash_Body_Scroll["bg_color"] == "transparent":
...
def Get_Dashboard_Widget_Frame_Header(Configuration:dict, Frame: CTkFrame, Widget_Line: str, Widget_size: str) -> CTkFrame:
...
def Get_Dashboard_Widget_Frame_Area(Configuration:dict, Frame: CTkFrame, Widget_Line: str, Widget_size: str) -> CTkFrame:
...
# ------------------------------------------ Widget Field Frames ------------------------------------------#
def Get_Widget_Field_Frame_Area(Configuration:dict, Frame: CTkFrame, Field_Frame_Type: str, GUI_Level_ID: int|None = None) -> CTkFrame:
    Configuration_Field_Single_Area = Configuration["Frames"]["Widgets"]["Field_Frames"][f"{Field_Frame_Type}"]["Area"]

    if type(GUI_Level_ID) is int:
        fg_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID}"]["fg_color"])
        if GUI_Level_ID == 0:
            bg_color = tuple(Configuration_Field_Single_Area["bg_color"])
        else:
            bg_color = tuple(Configuration["Global_Appearance"]["GUI_Level_ID"][f"{GUI_Level_ID - 1}"]["fg_color"])
    else:
        if Configuration_Field_Single_Area["fg_color"] == "transparent":
            fg_color = Configuration_Field_Single_Area["fg_color"]
        else:
            fg_color = tuple(Configuration_Field_Single_Area["fg_color"])
        if Configuration_Field_Single_Area["bg_color"] == "transparent":
...
# ---------------------------------------------- CTkToolTip ----------------------------------------------# 
def Get_ToolTip(Configuration:dict, widget: any, message: str, ToolTip_Size, GUI_Level_ID: int|None = None) -> CTkToolTip:
