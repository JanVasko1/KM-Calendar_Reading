...
def Get_Widget_Input_row(Settings: dict, Frame: CTk|CTkFrame, Field_Frame_Type: str, Label: str, Field_Type: str, Var_Value: int|str|None = None,  Validation: str|None = None) -> CTkFrame:
    ...
    if Field_Type == "Input_Normal":
        Field_Normal = Elements.Get_Entry_Field(Settings=Settings, Frame=Frame_Value, Field_Size="Normal", Validation=Validation)
        ...
        Field_Small = Elements.Get_Entry_Field(Settings=Settings, Frame=Frame_Value, Field_Size="Small", Validation=Validation)
...
def Get_Double_Field_Input(Settings: dict, Frame: CTk|CTkFrame, Field_Frame_Type: str, Label: str,  Validation: str|None = None) -> CTkFrame:
    ...
    Field_Small1 = Elements.Get_Entry_Field(Settings=Settings, Frame=Frame_Value1, Field_Size="Small", Validation=Validation)
    ...
    Field_Small2 = Elements.Get_Entry_Field(Settings=Settings, Frame=Frame_Value2, Field_Size="Small", Validation=Validation)
