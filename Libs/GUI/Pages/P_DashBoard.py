...
def Page_Dashboard(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame):
    ...
    try:
        ...
        Frame_DashBoard_Totals_Counter = W_DashBoard.DashBoard_Totals_Counter_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="Count", Widget_Line="Totals_Line", Widget_size="Normal", Data=Event_counts)
        Frame_DashBoard_Totals_Counter.pack_propagate(flag=False)
        Frame_DashBoard_Totals_Total = W_DashBoard.DashBoard_Totals_Total_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="Total", Widget_Line="Totals_Line", Widget_size="Normal", Data=Total_Duration_hours)
        Frame_DashBoard_Totals_Total.pack_propagate(flag=False)
        Frame_DashBoard_Totals_Average = W_DashBoard.DashBoard_Totals_Average_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="Average", Widget_Line="Totals_Line", Widget_size="Normal", Data=Mean_Duration_hours)
        Frame_DashBoard_Totals_Average.pack_propagate(flag=False)
        Frame_DashBoard_Totals_Active_Day_Util = W_DashBoard.DashBoard_Totals_Active_Day_Util_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="My Active Days Utilization", Widget_Line="Totals_Line", Widget_size="Normal", Data=My_Calendar_Utilization)
        Frame_DashBoard_Totals_Active_Day_Util.pack_propagate(flag=False)
        Frame_DashBoard_Totals_Util_by_today_surplus = W_DashBoard.DashBoard_Totals_Utilization_Surplus_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="Displayed period surplus", Widget_Line="Totals_Line", Widget_size="Normal", Data=Utilization_Surplus_hours)
        Frame_DashBoard_Totals_Util_by_today_surplus.pack_propagate(flag=False)
        Frame_DashBoard_Totals_Report_Per_Util = W_DashBoard.DashBoard_Totals_Report_Period_Util_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Total_Line, Label="Reported Period Utilization", Widget_Line="Totals_Line", Widget_size="Normal", Data=Reporting_Period_Utilization)
        ...
        Frame_DashBoard_Project_Frame = W_DashBoard.DashBoard_Project_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Project_Detail_Section, Label="Projects", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity", Project_DF=Project_DF)
        ...
        Frame_DashBoard_Project_Detail1_Frame = W_DashBoard.DashBoard_Project_Detail1_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Project_Side_Section, Label="Most Occurrence", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Project_DF=Project_DF)
        Frame_DashBoard_Project_Detail1_Frame.pack_propagate(flag=False)
        Frame_DashBoard_Project_Detail2_Frame = W_DashBoard.DashBoard_Project_Detail2_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Project_Side_Section, Label="Most Hours", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Project_DF=Project_DF)
        Frame_DashBoard_Project_Detail2_Frame.pack_propagate(flag=False)
        Frame_DashBoard_Project_Detail3_Frame = W_DashBoard.DashBoard_Project_Detail3_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Project_Side_Section, Label="Highest Average", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Project_DF=Project_DF)
        ...
        Frame_DashBoard_Activity_Frame = W_DashBoard.DashBoard_Activity_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Activity_Detail_Section, Label="Activity", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity", Activity_Df=Activity_Df)
        ...
        Frame_DashBoard_Activity_Detail1_Frame = W_DashBoard.DashBoard_Activity_Detail1_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Activity_Side_Section, Label="Most Occurrence", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Activity_Df=Activity_Df)
        Frame_DashBoard_Activity_Detail1_Frame.pack_propagate(flag=False)
        Frame_DashBoard_Activity_Detail2_Frame = W_DashBoard.DashBoard_Activity_Detail2_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Activity_Side_Section, Label="Most Hours", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Activity_Df=Activity_Df)
        Frame_DashBoard_Activity_Detail2_Frame.pack_propagate(flag=False)
        Frame_DashBoard_Activity_Detail3_Frame = W_DashBoard.DashBoard_Activity_Detail3_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Activity_Side_Section, Label="Highest Average", Widget_Line="Project_Activity_Line", Widget_size="Project_Activity_Details", Activity_Df=Activity_Df)
        ...
        Frame_DashBoard_WeekDays_Frame = W_DashBoard.DashBoard_WeekDays_Widget(Configuration=Configuration, Frame=Frame_Dashboard_WeekDay_Weeks_Line, Label="WeekDays", Widget_Line="WeekDay_Weeks", Widget_size="Normal", WeekDays_Df=WeekDays_Df)
        Frame_DashBoard_Weeks_Frame = W_DashBoard.DashBoard_Weeks_Widget(Configuration=Configuration, Frame=Frame_Dashboard_WeekDay_Weeks_Line, Label="Weeks", Widget_Line="WeekDay_Weeks", Widget_size="Normal", Weeks_DF=Weeks_DF)
        ...
        Frame_DashBoard_Chart_Frame = W_DashBoard.DashBoard_Chart_Widget(Configuration=Configuration, Frame=Frame_Dashboard_Day_Chart_Line, Label="Charts", Widget_Line="WeekChart", Widget_size="Normal")
