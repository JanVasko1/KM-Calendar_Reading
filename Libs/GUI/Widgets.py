...
def Download_Sharepoint(Frame: CTk|CTkFrame, Download_Method: IntVar) -> CTkFrame:
    ...
    User_ID.pack(side="top", padx=10, pady=10)
    ...
    Password.pack(side="top", padx=10, pady=10)
...
def Download_Manual(Frame: CTk|CTkFrame, Download_Method: IntVar) -> CTkFrame:
    ...
    # Field - User ID
    Date_From = Elements_Groups.Get_Single_Field_Imput(Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date From", Field_Type="Input_Normal") 
    Date_From_Text_Var = Date_From.children["!ctkframe3"].children["!ctkentry"]
    Date_From_Text_Var.configure(placeholder_text="Date From")
    Date_From.pack(side="top", padx=10, pady=10)

    # Field - User Email
    Date_To = Elements_Groups.Get_Single_Field_Imput(Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date To", Field_Type="Input_Normal")
    Date_To_Text_Var = Date_To.children["!ctkframe3"].children["!ctkentry"]
    Date_To_Text_Var.configure(placeholder_text="Date To")
    Date_To.pack(side="top", padx=10, pady=10)
...
def Settings_Parralel_events(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Divide_Method_Frame.pack(side="top", padx=10, pady=10)
    ...
    Start_Method_Frame.pack(side="top", padx=10, pady=10)
...
def Settings_Calendar_Working_Hours(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Monday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Tuesday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Wednesday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Thursday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Friday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Saturday_Frame.pack(side="top", padx=10, pady=10)
    ...
    Sunday_Frame.pack(side="top", padx=10, pady=10)
...
def Settings_Calendar_Start_End_Time(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Start_Event.pack(side="top", padx=10, pady=10)
...
def Settings_Events_General_Skip(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Frame_Imput_Total.configure(height=50)
    Frame_Imput_Total.pack_propagate(False)
    ...
    Frame_Button_Area = Elements.Get_Widget_Field_Frame_Area(Frame=Frame_Imput_Total, Field_Frame_Type="Single_Column")
    ...
    """Skip_List_Table = Elements.Get_Table(Frame=Frame_Main, Table_size="Single_size")
    Show_Skip_Events_list = []
    for skip_Subject in Skip_Events_list:
        Show_Skip_Events_list.append([skip_Subject])
    Skip_List_Table.configure(columns=1, rows=len(Skip_Events_list), values=Show_Skip_Events_list)
    Skip_List_Table.pack(side="top", expand=True, fill="both", padx=10, pady=10)"""
...
def Settings_Events_Empty_Generaly(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    # Field - Subject
    Subject_Text = Elements_Groups.Get_Single_Field_Imput(Frame=Frame_Imput_Area, Field_Frame_Type="Single_Column" , Label="Subject", Field_Type="Input_Normal") 
    Subject_Text_Text_Var = Subject_Text.children["!ctkframe3"].children["!ctkentry"]
    Subject_Text_Text_Var.configure(placeholder_text="Add new text")
    Subject_Text.pack(side="top", padx=10, pady=10)
    ...
    Project_Option.pack(side="top", padx=10, pady=10)
    ...
    # Empty Events table
    #! Dodělat --> mám Issue na Stuck overFlow https://github.com/Akascape/CTkTable/issues/116
    """Skip_List_Table = Elements.Get_Table(Frame=Frame_Table_Area, Table_size="Double_size")
    Show_Skip_Events_list = []
    for skip_Subject in Skip_Events_list:
        Show_Skip_Events_list.append([skip_Subject])
    Skip_List_Table.configure(columns=1, rows=len(Skip_Events_list), values=Show_Skip_Events_list)
...
def Settings_Events_Empt_Schedule(Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Start_Time_Text.pack(side="top", padx=10, pady=10)
